...
public class EnregistrerOpCommande  implements Commande{
	...
	/** operande de type Double pour le rajouter a la pile des opérandes.
	    * @see AjouterUnOperande#AjouterUnOperande( MoteurRPN , Double)
	    * @see AjouterUnOperande#execute()
	    */
	private Double op;
	...
	/**
	 * constructeur EnregistrerOpCommande.
	 * qui initialise this.op a op , et couper la reference de moteurRPN dans this.moteurRPN.
	 * @param moteurRPN c'est un objet de type MoteurRPN.
	 * @param op L'operande de type Double  pour l'ajouter dans la pile.
	 * @see EnregistrerOpCommande#moteurRPN .
	 * @see EnregistrerOpCommande#op .
	 * */
	public EnregistrerOpCommande(MoteurRPN moteurRPN,Double op)
	{
		this.op=op;
		this.moteurRPN=moteurRPN;
	}
	/**
	 * Méthode execute qui fait appelle a la méthode enregistrerOp de MoteurRPN pour 
