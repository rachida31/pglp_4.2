...
public class RetournerOpCommande implements Commande {
	 ...
	 * @see RetournerOpCommande#AjouterUnOperande
	 * ( MoteurRPN , Double )
	...
	/**
	 * constructeur OperationOpCommande. qui couper
	 * la reference de moteurRPN dans
	 * this.moteurRPN.
	 * @param moteurRPN c'est un objet de type
	 * MoteurRPN.
	 * @see RetournerOpCommande#moteurRPN .
	 */
	public RetournerOpCommande(final MoteurRPN moteurRPN) {
		this.moteurRPN = moteurRPN;
	}

	/**
	 * Méthode execute qui fait appelle a la méthode
	 * retournerOp de MoteurRPN pour.
